...
SELECT customers.company_name AS customer, employees.first_name || employees.last_name AS employe FROM orders
...
WHERE EXISTS (SELECT * FROM order_details WHERE product_id = products.product_id AND quantity = 10)